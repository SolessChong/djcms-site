...
STATICFILES_DIRS = (
    ...
    #'/home/chong/soft/djcode/cmstest/static/',
    '/home/chong/soft/djcode/cmstest/cmstest/static/',
)
...
SECRET_KEY = 't2#ms1)!oaf@a&#fyow*y^ve%$+mlu3u#(w=a%!!0lg1ci*fmm'
...
CMS_TEMPLATES = (
    ...
    ('projectspage.html', gettext('projectspage')),
    ('gallerypage.html', gettext('gallerypage')),
